...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(ReceiptAlreadyExistException.class)
	public ResponseEntity<String> handle(ReceiptAlreadyExistException e) {
		return new ResponseEntity<>(e.getMessage(), HttpStatus.NOT_FOUND);
	}
	...
	@ExceptionHandler(NoSuchReceiptExistException.class)
	public ResponseEntity<String> handle(NoSuchReceiptExistException e) {
		return new ResponseEntity<>(e.getMessage(), HttpStatus.NOT_FOUND);
	}
