...
public class AdminController {
	...
	public List<Car>getCarAllDetails(){
		return adminService.allCarDetails();
	}
	
	@PutMapping("/assignWasherName/{orderId}")
	public void addWasherName(@RequestBody OrderDetails order, @PathVariable String orderId) {
		adminService.assignWasherName(order, orderId);
